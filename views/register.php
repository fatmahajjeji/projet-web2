...
<div class="container">
    ...
    <ul class="nav nav-pills nav-fill gap-2 p-1 small bg-primary rounded-5 shadow-sm" id="pillNav2" role="tablist" style="--bs-nav-link-color: var(--bs-white); --bs-nav-pills-link-active-color: var(--bs-primary); --bs-nav-pills-link-active-bg: var(--bs-white);">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active rounded-5" id="profile-tab2" data-bs-toggle="tab" type="button" role="tab" aria-selected="false" onclick="window.location.href='acceuil.php'">S'inscrire</button>
        </li>
    </ul>
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-6 form-container">
            ...
            <form method="post" action="../controllers/RegisterController.php">
                ...
                <!-- Hidden role field (default to "etudiant") -->
                <input type="hidden" name="role" value="etudiant">
    
                <button type="submit" class="btn btn-custom w-100" name="envoyer" style="color: white;">S'inscrire</button>
            </form>
        </div>
    </div>
